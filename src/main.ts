...
app!.innerHTML = `
    <div>       
        <h1>Привет, <span>${nameUser || "путник"} ${nameUserLast || ""}!</span></h1>
        ...
        <p>Ты ${isPremiumUser ? "премиум пользователь" : "не премиум пользователь"}</p>
        <p>Ты ${isAttachmentMenu ? "добавил бота в меню приложений" : "не добавил бота в меню приложений"}</p>
        <p>Ты ${isAllowsWriteToPm ? "разрешаешь писать боту" : "не разрешаешь писать боту"}</p>
